<footer>
    <div class="col span_1_of_2" id="foot-col-left">
        <h4>Company &nbsp; 
            <ul>
        ...
        <h4>Razor.com &nbsp;
            <ul>
                <li>Copyright © 2021 Razer Inc. All rights reserved. &nbsp;</li>
    ...
    <div class="col span_1_of_2" id="foot-col-right">
        <ul id="green">
            <li>FOR GAMERS. BY GAMERS.™ &nbsp; </li>
