...
<body>
    ...
    <section class="gradient" style="background-image: url(../resource/img/cry3.jpg); background-position: 0% 30%;"></section>
    <!-- ------------------------------------------------------------------------------ -->


    <section class="sec-light" style="background-image: url(../resource/img/cry44.jpg); background-position: 0 0;">
    ...
    <!-- ------------------------------------------------------------------------------------->
    <div class="gradient" style="background-image: url(../resource/img/cry1.png); background-position: 0% 50%;  height:1090px;">
    </div>
    <!-- ------------------------------------------------------------------------------------->
    <section class="sec-dark" style="background-image: url(../resource/img/cry2.png);">
        <div class="row" style="margin: 6% 5% 0 3%;">
            <div class="col span_1_of_2">
                <h2>RAZER CORTEX: GAME BOOSTER</h2>
                <p class="long-text">
                    Enjoy higher framerates and faster load times by tuning your PC with our suite of gaming optimization tools.
