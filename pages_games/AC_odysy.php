...
<head>
    ...
    <style>
        ...
        #cb2 {
            background-image: url(../resource/img/cyberpunk22.jpg);
            background-position: -500px 35%;
...
<body>
    <!-- ------------------------------------------------------------------------------ -->
    <div class="gradient">
        <img src="../resource/img/assassins_creed_odyssey_kassandra_alexios.jpg">
    </div>
    <!-- ------------------------------------------------------------------------------ -->
    <section class="sec-dark" style="background-image: url(../resource/img/cyberpunk3.jpg);">
    ...
    <!-- ------------------------------------------------------------------------------------->
    <section class="sec-light" id="cb2">
